...
//Download Product Image
    ...
    private boolean isCart(SQLManager sqlManager, CategoryRowAdapter.Holder holder, int position) {
    ...
    @SuppressLint("UseCompatLoadingForDrawables")
    private boolean isFavorite(SQLManager sqlManager, CategoryRowAdapter.Holder holder, int position){
        //Ürünü veritabanında sorgulamak için ürün ID'sini değiştirilemez şekilde oluşturulması
        final long productId = products.get(position).getProductId();
